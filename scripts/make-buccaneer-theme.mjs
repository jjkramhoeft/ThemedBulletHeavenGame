...
import { creditsCsv, crowd, Lpc, walkFrames } from './lib/lpc.mjs';
import { slingLongGun } from './lib/props.mjs';
...
for (const [actor, recipe] of Object.entries(RECIPES)) {
  ...
  if (recipe.musket) slingLongGun(sheet, lpc.composeOnly(recipe, ['body']), { stock: WOOD, stockDark: WOOD_DARK, barrel: IRON_DARK, ink: INK });
